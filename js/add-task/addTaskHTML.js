...
<div class="divColumn">
  ...
  <div id="taskTitleContainer">
    ...
    <input
      ...
      oninput="checkInputs()"
    />
    <p id="inputRequiredContainer" class="fieldIsRequiredText"></p>
  </div>
  ...
  <div id="taskDueDateContainer">
    ...
    <input
      ...
      oninput="checkInputs()"
    />
    <p id="dueDateRequiredContainer" class="fieldIsRequiredText"></p>
  </div>
  ...
  <div id="taskCategoryContainer">
    ...
    <p id="categoryRequiredContainer" class="fieldIsRequiredText"></p>
  </div>
...
window.editSubtaskReturn = function (subtasks, i) {
  return `<div class="subtaskEdit" id="subtaskEdit">
    <input type="text" id="editSubtask${i}" value="${subtasks[i].name}">
...
window.loadContactsReturn = function (i) {
  const contact = window.contacts[i];
  return `
  <div
      id="assignedContactContainer${i}"
      onclick="assignedToContactBg(${i}, '${contact.name}')"
      class="assignedContactContainer"
    >
      <div class="assignedContactLeftSide">
        <div id="ContactSignatureIcon${i}" class="assignedContactLeftSideIcon">${contact.signature}</div>
        <p class="assignedContactNameClass">${contact.name}</p>
      </div>
      <img
...
window.loadContactsAssignedReturn = function (i) {
  const contact = window.contacts[i];
  return `
  <div
      id="assignedContactContainer${i}"
      onclick="removeAssignedToContactBg(${i}, '${contact.name}')"
      class="assignedContactContainer"
    >
      <div class="assignedContactLeftSide">
        <div id="ContactSignatureIcon${i}" class="assignedContactLeftSideIcon">${contact.signature}</div>
...
window.footerReturn = function () {
  ...
  <div id="finishTaskContainer">
    ...
    <div id="clearTaskButton" class="clearAll font" onclick="clearInputs()">
      Clear
...
window.footerMobileReturn = function () {
  return `
  <footer>
  <div id="finishTaskContainer">
    <div class="finishTaskText">
...
window.filterNamesForAssignedToReturn = function (i) {
  return `
